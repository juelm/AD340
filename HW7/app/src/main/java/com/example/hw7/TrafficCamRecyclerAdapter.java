...
//                .inflate(R.id.textview, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull TrafficCamRecyclerAdapter.ViewHolder viewHolder, final int i) {
